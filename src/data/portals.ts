import { Shield, Building2, DollarSign, Users, Trophy } from "lucide-react";
...
export const PORTALS: Portal[] = [
  ...
  { key: "staff", name: "Staff / Coach", shortName: "Coach", description: "View schedule, take attendance, and log session notes.", icon: Trophy, path: "/staff" },
];
