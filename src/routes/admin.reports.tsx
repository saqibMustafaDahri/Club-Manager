...
// import { PageHeader } from "@/components/PageHeader";
// import { Button } from "@/components/ui/button";
// import { monthlyRevenue, funnelData } from "@/data/mockReports";
...
//   capacityUtilisation: CapacityItem[];
// }
...
//       .then(setDashboard)
//       .catch((err) => setApiError(err instanceof Error ? err.message : "Failed to load report data."))
...
//   // Map API response to chart-friendly shape
...
//         {/* ── Capacity Utilisation — real API data ── */}
//         <Panel title="Capacity Utilisation" subtitle="Enrolled vs total capacity per location">
//           {loading ? (
