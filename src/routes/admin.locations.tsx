...
//       try {
//         // Fetch users in parallel so we can resolve manager IDs → names
//         const [users] = await Promise.allSettled([usersApi.getAll()]);
...
//           }
//         }
//         const data = await locationsApi.getAll(userMap);
//         setLocations(data);
//       } catch (err) {
...
//       header: "Manager",
//       render: (r) => {
//         const name = typeof r.manager === "string" ? r.manager : "—";
...
//               <SheetHeader>
//                 <SheetTitle>{selected.name}</SheetTitle>
//                 <SheetDescription>{selected.city} • Manager: {typeof selected.manager === "string" ? selected.manager : "Unassigned"}</SheetDescription>
//               </SheetHeader>
...
//       try {
//         const [usersData, locData] = await Promise.all([
//           usersApi.getAll(),
//           locationsApi.getAll(),
//         ]);

//         // Build map: locationId → manager name (LOCATION_MANAGER role only)
...
//         // Inject resolved manager name into each location
...
//                 <SheetTitle>{selected.name}</SheetTitle>
//                 <SheetDescription>
//                   {selected.city} • Manager: {selected.manager && selected.manager !== "—" ? selected.manager : "Unassigned"}
//                 </SheetDescription>
//               </SheetHeader>
