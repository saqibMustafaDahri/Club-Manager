...
//       const fullName = p ? `${p.firstNameEn} ${p.lastNameEn}` : "Unknown";
//       if (q) {
...
//     setFormLoading(true);
//     try {
//       const created = await enrolmentsApi.create({
...
//     try {
//       const updated = await enrolmentsApi.reEnrol(reEnrolSelected.id, {
//         sessionId: reEnrolForm.sessionId,
//         paymentPlanType: reEnrolForm.paymentPlanType,
//       });
...
//         return s ? s.name : r.sessionId;
//       },
//     },
//     {
//       key: "location", header: "Location",
//       render: (r) => {
//         const l = locations.find(loc => loc.id === r.locationId);
//         return l ? l.name : r.locationId;
//       },
//     },
//     {
//       key: "paymentPlanType", header: "Payment Plan",
...
//                 onValueChange={(val) => setForm((f) => ({ ...f, participantId: val }))}
//               >
...
//                 onValueChange={(val) => setForm((f) => ({ ...f, sessionId: val }))}
//               >
...
//                 onValueChange={(val) => setForm((f) => ({ ...f, paymentPlanType: val }))}
//               >
...
//                 {formLoading ? "Creating…" : "Create Enrolment"}
//               </Button>
//             </SheetFooter>
//           </form>
//         </SheetContent>
...
//               <Label>Session</Label>
//               <Select
//                 value={reEnrolForm.sessionId}
//                 onValueChange={(val) => setReEnrolForm((f) => ({ ...f, sessionId: val }))}
//               >
//                 <SelectTrigger><SelectValue placeholder="Select session" /></SelectTrigger>
//                 <SelectContent>
//                   {sessions.map((s) => (
...
//               <Label>Payment Plan Type</Label>
//               <Select
//                 value={reEnrolForm.paymentPlanType}
//                 onValueChange={(val) => setReEnrolForm((f) => ({ ...f, paymentPlanType: val }))}
//               >
//                 <SelectTrigger><SelectValue placeholder="Select plan type" /></SelectTrigger>
//                 <SelectContent>
...
//             <SheetFooter className="pt-4">
//               <Button type="button" variant="outline" onClick={() => setReEnrolOpen(false)} disabled={reEnrolLoading}>
//                 Cancel
//               </Button>
//               <Button type="submit" disabled={reEnrolLoading}>
//                 {reEnrolLoading ? "Processing…" : "Re-enrol"}
//               </Button>
//             </SheetFooter>
//           </form>
//         </SheetContent>
...
//                 <p className="text-[11px] uppercase tracking-wide text-muted-foreground">Participant</p>
//                 <p className="mt-0.5 text-sm font-medium">
//                   {participants.find(p => p.id === selected.participantId)?.firstNameEn} {participants.find(p => p.id === selected.participantId)?.lastNameEn}
//                 </p>
//               </div>
//               <div className="rounded-md bg-muted/30 p-3">
//                 <p className="text-[11px] uppercase tracking-wide text-muted-foreground">Session</p>
//                 <p className="mt-0.5 text-sm font-medium">
//                   {sessions.find(s => s.id === selected.sessionId)?.name}
//                 </p>
//               </div>
//               <div className="rounded-md bg-muted/30 p-3">
...
//               </div>
//               <div className="rounded-md bg-muted/30 p-3">
//                 <p className="text-[11px] uppercase tracking-wide text-muted-foreground">Payment Plan</p>
//                 <p className="mt-0.5 text-sm font-medium">
//                   {selected.paymentPlanType}
//                 </p>
//               </div>
//               <div className="rounded-md bg-muted/30 p-3">
